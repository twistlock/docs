...
When you upgrade Compute, integrations can still access the endpoints from the previous release, so you can expect integrations to remain fully functional across upgrades.
