Creates the initial admin user after the Console is first installed, to help automation of the Console setup. Invoke this endpoint after Twistlock is first installed.
