...
For more information, see the Prisma Cloud xref:../install/install_openshift_3_11.adoc[OpenShift 3] and xref:../install/install_openshift_3_11.adoc[OpenShift 4] deployment guides.
