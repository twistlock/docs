...
[.section]
===== Console Syslog Output Types

The below table describes each output type as well as the sub-types associated with each parent syslog typing.
