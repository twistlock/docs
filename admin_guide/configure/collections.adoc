...
After a collection creation or a collection update, there are some views that will be affected by the change only for future records. These views include historical records that keep their collections from their creation time:
