...
For all other integrations, manually create the required service accounts or roles according to the xref::http://cdn.twistlock.com/docs/downloads/Compute-Feature-Wise-Permissions.pdf[feature-wise permissions doc].
