...
3+|Alerting -- AWS SecurityHub
3+|Alerting -- GCP SecurityCenter
3+|Alerting -- Google Cloud Pub/Sub
3+|Secret stores -- Azure Key Vault
3+|Secret stores -- AWS Secret Manager
3+|Secret stores -- AWS System Manager Parameter Store
