...
. Open Prisma Cloud Console's web interface. The Web interface is available via HTTPS (port 8083) by default although you can configure HTTP access via the configuration file.
Go to \https://<LOAD-BALANCER>:8083 for HTTPS 
+
