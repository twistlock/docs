...
* AWS Lambda has a limit of xref:https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html[5 layers] per function. If you plan to use mutiple layers and might reach this limit, consider choosing the xref:install_serverless_defender.adoc[embedded] option.
