...
NOTE: Starting in Galileo, each instance of Console will be able to support 10K Defenders. With this new capability, we will deprecate scale projects. See xref:./migration_paths_for_scale_projects.adoc[Migration paths for scale projects] for more information and possible migration paths.
