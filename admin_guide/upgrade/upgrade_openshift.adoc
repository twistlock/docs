...
+
  $ <PLATFORM>/twistcli console export openshift \
    ...
    --service-type "ClusterIP"
+
For other command variations, see the xref:../install/install_openshift_3_11.adoc[OpenShift 3] and xref:../install/install_openshift_4.adoc[OpenShift 4] deployment guides.
