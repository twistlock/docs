...
The following examples should give you some ideas about how you can create your own policies by using the Rego language and syntax.

* Do not allow to create a new namespace
...
* Do not allow a specific image (for example nginx) for a new pod
...
----
* Do not allow the usage of TCP port 80 for a new Pod
