...
By default, Defender establishes a connection to Console on TCP port 443, although the port number can be customized to meet the needs of your environment.
...
Defender has no ability to interact with Console beyond port 443.
