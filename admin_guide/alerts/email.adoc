...
NOTE: Due to the hosting of Enterprise Edition Compute in Google Cloud Platform, port 25 is blocked outbound from Console.  All other ports are available for use, including 587 and 465.  
For more information, see:  https://cloud.google.com/compute/docs/tutorials/sending-mail
