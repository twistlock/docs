...
[NOTE]
====
If a user is assigned multiple system roles, either directly or through group inheritance, then he is granted the rights of the highest role. If a user is assigned both system and custom roles, then he will be randomly granted the rights of one of the roles.
