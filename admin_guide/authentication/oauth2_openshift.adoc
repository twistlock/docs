...
NOTE: Prisma Cloud currently supports Openshift Platform versions <4.6 as an OAuth 2.0 provider. We are working to add support for Openshift versions greater than 4.6.
